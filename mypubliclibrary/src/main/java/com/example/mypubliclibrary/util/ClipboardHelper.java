...
public class ClipboardHelper {
    ...
    private void initOnPrimaryClipChangedListener() {
    ...
    public interface ClipboardListener {
        void onClip(String value);
    }

    /**
     * 添加剪贴板监听，得到监听事件后，再利用该工具类获取当前剪贴值
     * 页面销毁时一定要removeListener，否则会造成内存泄露
     *
     * @param onPrimaryClipChangedListener onPrimaryClipChangedListener
     */
    public void addListener(ClipboardManager.OnPrimaryClipChangedListener onPrimaryClipChangedListener) {
