...
public class SelectRecycle {
    ...
    // Wheel view
    private SelectWheelView selectView;

    /**
     * Constructor
     *
     * @param selectView the wheel view
     */
    public SelectRecycle(SelectWheelView selectView) {
    ...
    private void recycleView(View view, int index) {
        int count = selectView.getViewAdapter().getItemsCount();

        if ((index < 0 || index >= count) && !selectView.isCyclic()) {
            // empty view
