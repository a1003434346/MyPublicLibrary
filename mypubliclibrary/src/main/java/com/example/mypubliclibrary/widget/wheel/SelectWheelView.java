...
import com.example.mypubliclibrary.widget.wheel.interfaces.OnSelectClickedListener;
import com.example.mypubliclibrary.widget.wheel.interfaces.OnSelectScrollListener;
import com.example.mypubliclibrary.widget.wheel.interfaces.OnWheelChangedListener;
import com.example.mypubliclibrary.widget.wheel.interfaces.SelectViewAdapter;
...
public class SelectWheelView extends View {
    ...
    // Scrolling
    private SelectScroller scroller;
    ...
    // View adapter
    private SelectViewAdapter viewAdapter;

    // Recycle
    private SelectRecycle recycle = new SelectRecycle(this);

    // Listeners
    private List<OnSelectChangedListener> changingListeners = new LinkedList<>();

    private List<OnSelectScrollListener> scrollingListeners = new LinkedList<>();

    private List<OnSelectClickedListener> clickingListeners = new LinkedList<>();

    /**
     * 中间线的颜色
     */
    private String lineColorStr = "#AAB7B7B7";
     ...
     * Constructor
     */
    public SelectWheelView(Context context, AttributeSet attrs, int defStyle) {
     ...
     * Constructor
     */
    public SelectWheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initData(context);
    }
    ...
    // Scrolling listener
    SelectScroller.ScrollingListener scrollingListener = new SelectScroller.ScrollingListener() {
        @Override
     ...
     */
    public SelectViewAdapter getViewAdapter() {
        return viewAdapter;
    }
     ...
     */
    public void setViewAdapter(SelectViewAdapter viewAdapter) {
     ...
     */
    public void addChangingListener(OnSelectChangedListener listener) {
    ...
    protected void notifyChangingListeners(int oldValue, int newValue) {
        for (OnSelectChangedListener listener : changingListeners) {
     ...
     * @param listener the listener
     */
    public void addScrollingListener(OnSelectScrollListener listener) {
     ...
     * @param listener the listener
     */
    public void removeScrollingListener(OnSelectScrollListener listener) {
    ...
    protected void notifyScrollingListenersAboutStart() {
        for (OnSelectScrollListener listener : scrollingListeners) {
     ...
     * @param listener the listener
     */
    public void addClickingListener(OnSelectClickedListener listener) {
     ...
     * @param listener the listener
     */
    public void removeClickingListener(OnSelectClickedListener listener) {
    ...
    protected void notifyClickListenersAboutClick(int item) {
        for (OnSelectClickedListener listener : clickingListeners) {
    ...
    public void setCurrentItem(int index, boolean animated) {
        ...
        //fixme 如果更改的选项是当前item,那么就不进行事件操作,这个条件不合理,所以去掉
